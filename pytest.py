from pytest import fixture  # This line imports the fixture from the pytest module
from pytest import mark  # This line imports the mark from the pytest module
...
# Multiple testcase
@mark.smoke  # smoke is the customised marker
def test_firsttestcase():
    assert 1 + 2 == 3
...
@mark.smoke  # This decorator tags the test function with the smoke marker(smoke is the customised marker)
@mark.product  # This decorator tags the test function with the product marker(product is the customised marker)
def test_method_method():
    assert 6 == 3 * 2

@mark.product  # product is the customised marker
def test_method_tw0():
    assert 5 + 2 == 7
...
@mark.product  # This decorator tags the test class with the product marker(product is the customised marker)
class TestProduct:
...
@mark.param_testcase # param_testcase is the customised marker
...
@mark.fixture_sampl1  # fixture_sampl1 is the customised marker
